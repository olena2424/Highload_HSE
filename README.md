...
Для динамического управления нагрузкой и отказоустойчивости в проекте предполагается комбинация GeoDNS с весами.

В GeoDNS можно изменять пропорции возвращаемых IP-адресов в зависимости от текущей нагрузки на ДЦ. Например, если ДЦ в США перегружен, уменьшаем вес его A-записи, и часть трафика пойдёт в Европу (для пользователей, у которых задержка приемлема).
